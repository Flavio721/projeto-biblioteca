...
async function startServer() {
  try {
    ...
    if (!emailOk) {
      ...
      console.log(
        "   → O servidor continuará rodando, mas emails não serão enviados",
      );
    ...
    app.listen(PORT, () => {
      ...
      console.log(
        `   Email: ${emailOk ? "✅ Configurado" : "⚠️  Não configurado"}`,
      );
      console.log("=================================\n");
      ...
      if (emailOk) {
        ...
        console.log(
          "✅ Verificações configuradas para rodar todo dia às 09:00\n",
        );
