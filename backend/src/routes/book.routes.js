...
import {list, getCategories, getById, create, update, remove, popularBooks, popularCategories } from '../controllers/bookController.js';
...
router.get('/popular-books', authMiddleware, checkRole("ADMIN", "LIBRARIAN"), popularBooks);

router.get('/popular-categorie', authMiddleware, checkRole("ADMIN", "LIBRARIAN"), popularCategories);
router.put('/:id',
    authMiddleware,
    isLibrarian,
    upload.single('coverImage'),
